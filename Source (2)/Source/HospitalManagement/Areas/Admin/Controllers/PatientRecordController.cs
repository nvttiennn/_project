            ...
            try
            {
                ...
                if (isEdit) //update
                {
                    using (var workScope = new UnitOfWork(new HospitalManagementDbContext()))
                    {
                        ...
                        if (elm != null) //update
                        {
                            ...
                            input.DoctorId = input.DoctorId;//user.Role == RoleKey.Doctor ? user.DoctorId : input.DoctorId;
                            elm = input;
                ...
                using (var workScope = new UnitOfWork(new HospitalManagementDbContext()))
                {
                    ...
                    var record = new Record
                    {
                        ...
                        DoctorId = input.DoctorId//user.Role == RoleKey.Doctor ? user.DoctorId : null
                };
